export async function getNavigation(): Promise<TNavigationItem[]> {
  return [
    ...
    {
      id: '2',
      href: '/category/inspirasi-kebaikan',
      name: 'Kategori',
      type: 'dropdown',
      children: [
        { id: '2-1', href: '/category/inspirasi-kebaikan', name: 'Inspirasi Kebaikan' },
        { id: '2-2', href: '/category/khasanah-islam', name: 'Khasanah Islam' },
        { id: '2-3', href: '/category/kemanusiaan', name: 'Kemanusiaan' },
        { id: '2-4', href: '/category/update-penyaluran', name: 'Update Penyaluran' },
        { id: '2-5', href: '/category/keluarga', name: 'Keluarga' },
        { id: '2-6', href: '/category/teknologi', name: 'Teknologi' },
      ],
    },
    {
      id: '3',
      ...
      type: 'dropdown',
      children: [
        { id: '3-1', href: '/tag/kebaikan', name: '#kebaikan' },
        { id: '3-2', href: '/tag/ramadhan', name: '#ramadhan' },
        { id: '3-3', href: '/tag/sura', name: '#sura' },
        { id: '3-4', href: '/tag/sedekah', name: '#sedekah' },
        { id: '3-5', href: '/tag/yatim', name: '#yatim' },
        { id: '3-6', href: '/tag/qurban', name: '#qurban' },
      ],
    },
    {
      id: '4',
